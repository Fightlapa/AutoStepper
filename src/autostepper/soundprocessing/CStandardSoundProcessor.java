...
public class CStandardSoundProcessor implements ISoundProcessor
{
    ...
    public void ProcessMusic(Minim minimLib, File filename, float songLengthLimitSeconds, final TFloatArrayList[] manyTimes, final TFloatArrayList[] fewTimes)
    {
        ...
        for (int chunkIdx = 0; chunkIdx < totalChunks; ++chunkIdx) {
            ...
            if (beatDetectFrequencyHighSensitivity.isSnare(true))
            ...
            if (beatDetectFrequencyLowSensitivity.isSnare(true))
        ...
        bpm = Math.round(Averages.getMostCommonPhr00t(common, 0.5f, true));
    }

    void AddCommonBPMs(TFloatArrayList common, TFloatArrayList times, float doubleSpeed, float timePerSample) {
        float commonBPM = 60f / Averages.getMostCommonPhr00t(Utils.calculateDifferences(times, doubleSpeed), timePerSample, true);
