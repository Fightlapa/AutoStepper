...
public class AutoStepper {
    ...
    void analyzeUsingAudioRecordingStream(File filename, float seconds, String outputDir) {
        ...
        // BeatDetect beatDetectSoundHighSensitivity = new
        // BeatDetect(BeatDetect.SOUND_ENERGY, fftSize,
        // stream.getFormat().getSampleRate());
        // BeatDetect beatDetectSoundLowSensitivity = new
        // BeatDetect(BeatDetect.SOUND_ENERGY, fftSize,
        // stream.getFormat().getSampleRate());
        ...
        for (int chunkIdx = 0; chunkIdx < totalChunks; ++chunkIdx) {
            ...
            if (beatDetectFrequencyHighSensitivity.isSnare())
            ...
            if (beatDetectFrequencyLowSensitivity.isSnare())
        ...
        String originalNotes = OgStepGenerator.GenerateNotes(2, HARDMODE ? 2 : 4, manyTimes, fewTimes, MidFFTAmount,
                MidFFTMaxes, timePerSample, timePerBeat, startTime, seconds, false);
